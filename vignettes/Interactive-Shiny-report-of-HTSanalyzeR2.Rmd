...
The above screenshot shows the hypergeometric test result table where users can either get a general summary of the analysis parameters, choose which analysis and which gene set collection to show or download the result by different format.
...
The above screenshot shows the enrichment map of hypergeometric test result. Users can click the topright button to modify the figure based on their data and preference. After 
