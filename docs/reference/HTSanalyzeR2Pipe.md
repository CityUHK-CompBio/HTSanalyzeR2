...
- cores:
  ...
  A single integer or numeric value specifying the number of cores to be
  used for GSEA.
...
- nwaPvalues:
  ...
  of nodes in NWA analysis (see BioNet::scoreNodes and Dittrich et al.,
  2008 for details)
...
This pipeline function will finally return a list of GSCA object and NWA
object.
